require(["gitbook", "jquery"], function (gitbook, $) {
    ...
    function copyToClipboard(text) {
        if (window.clipboardData && window.clipboardData.setData) {
            ...
            try {
                ...
                console.warn("Nesanāca ielikt starpliktuvē", ex);
                return false;
            } finally {
    ...
    gitbook.events.bind("page.change", function () {
        $("pre").each(function () {
            ...
            var $copyCodeButton = $("<button class='copy-code-button'>Kopēt</button>");
            ...
            $copyCodeButton.click(function () {
                ...
                if ($codeContainer) {
                    ...
                    if (copyToClipboard(selectedText) == true) {
                        buttonNewText = "Nokopēts";
                        selectElementText($codeContainer.get(0));
                    } else {
                        buttonNewText = "Nesanāca nokopēt";
                        selectElementText($codeContainer.get(0));
                    }
